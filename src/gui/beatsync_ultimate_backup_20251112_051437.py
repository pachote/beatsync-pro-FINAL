...
class ResolutionInfoWidget(QWidget):
    ...
    def update_clips(self, clips_data):
        ...
        breakdown_text = f"âœ“ {count} clips imported"
        ...
        try:
            ...
            if hasattr(self, 'preset_selector'):
                try:
                    ...
                    effects = self.preset_selector.current_selections['effects']
                except Exception as e:
            ...
            edit_plan_formatted = {
                'clips': edit_plan,
                'aesthetic_style': color,
                'effects_style': effects  # NOW PASSING EFFECTS!
            }
